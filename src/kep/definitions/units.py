...
UNITS = odict([  # 1. MONEY
    ...
    ("услуги", 'rog'),
    ("Добыча полезных ископаемых", "bln_rub"),
    ("Обрабатывающие производства", "bln_rub"),
    ("Обеспечение электрической энергией, газом и паром; кондиционирование воздуха", "bln_rub"),
    ("Строительство", "bln_rub"),
    ("Транспортировка и хранение", "bln_rub"),
